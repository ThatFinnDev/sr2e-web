...
```csharp
public class ReCenterCommand : SR2E.SR2ECommand
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SR2ECommand](/docs/dev/api/sr2e/sr2ecommand) → [ReCenterCommand](/docs/dev/api/sr2e/commands/recentercommand)
