# InfiniteEnergyCommand

Namespace: SR2E.Commands

```csharp
public class InfiniteEnergyCommand : SR2E.SR2ECommand
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SR2ECommand](/docs/dev/api/sr2e/sr2ecommand) → [InfiniteEnergyCommand](/docs/dev/api/sr2e/commands/infiniteenergycommand)
