...
```csharp
public class PediaCommand : SR2E.SR2ECommand
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SR2ECommand](/docs/dev/api/sr2e/sr2ecommand) → [PediaCommand](/docs/dev/api/sr2e/commands/pediacommand)
