...
```csharp
public class ToggleUICommand : SR2E.SR2ECommand
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SR2ECommand](/docs/dev/api/sr2e/sr2ecommand) → [ToggleUICommand](/docs/dev/api/sr2e/commands/toggleuicommand)
