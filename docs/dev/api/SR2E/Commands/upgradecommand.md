...
```csharp
public class UpgradeCommand : SR2E.SR2ECommand
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SR2ECommand](/docs/dev/api/sr2e/sr2ecommand) → [UpgradeCommand](/docs/dev/api/sr2e/commands/upgradecommand)
