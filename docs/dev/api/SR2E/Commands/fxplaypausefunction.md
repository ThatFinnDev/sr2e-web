...
```csharp
public class FXPlayPauseFunction : UnityEngine.MonoBehaviour
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → Il2CppObjectBase → Object → Object → Component → Behaviour → MonoBehaviour → [FXPlayPauseFunction](/docs/dev/api/sr2e/commands/fxplaypausefunction)<br></br>
