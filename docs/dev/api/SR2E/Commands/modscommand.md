...
```csharp
public class ModsCommand : SR2E.SR2ECommand
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SR2ECommand](/docs/dev/api/sr2e/sr2ecommand) → [ModsCommand](/docs/dev/api/sr2e/commands/modscommand)
