...
```csharp
public class KillAllCommand : SR2E.SR2ECommand
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SR2ECommand](/docs/dev/api/sr2e/sr2ecommand) → [KillAllCommand](/docs/dev/api/sr2e/commands/killallcommand)
