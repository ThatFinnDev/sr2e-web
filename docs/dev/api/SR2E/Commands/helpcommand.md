...
```csharp
public class HelpCommand : SR2E.SR2ECommand
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [SR2ECommand](/docs/dev/api/sr2e/sr2ecommand) → [HelpCommand](/docs/dev/api/sr2e/commands/helpcommand)
...
`command` [String](https://docs.microsoft.com/en-us/dotnet/api/system.string)<br></br>
